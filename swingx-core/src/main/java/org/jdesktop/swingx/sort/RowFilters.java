...
public class RowFilters {
    ...
    /**
     * Returns a <code>RowFilter</code> that uses a boolean expression
     * to determine which entries to include.
     *
     ...
     * @return a <code>RowFilter</code> implementing the specified criteria
     */
    public static <M,I> RowFilter<M, I> booleanFilter(boolean bool,
    		int... indices) {
    	return (RowFilter<M,I>)new BooleanFilter(bool, indices);
    }
...
//                throw new IllegalArgumentException("Pattern must be non-null");
    ...
    private static class BooleanFilter extends GeneralFilter {
        private boolean bool;

        BooleanFilter(boolean bool, int[] columns) {
            super(columns);
            this.bool = bool;
        }
